...
const getUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const user = yield (0, user_repostory_1.getUserRepo)(userId);
        if (user) {
...
const createUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const user = req.body;
    try {
        const success = yield (0, user_repostory_1.createUserRepo)(user);
        if (success) {
            res.status(200).json({ data: user });
        }
        else {
...
const updateUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const success = yield (0, user_repostory_1.updateUserRepo)(updatedUser.uid, updatedUser);
        if (success) {
...
const deleteUserController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const userId = req.params.userId;
    try {
        const success = yield (0, user_repostory_1.deleteUserRepo)(userId);
        if (success) {
