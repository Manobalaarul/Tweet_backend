...
const tweet_repostory_1 = require("../repositories/tweet.repostory");
...
const getTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const tweet = yield (0, tweet_repostory_1.getTweetRepo)(tweetId);
        if (tweet) {
...
const getAllTweetsController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tweets = yield (0, tweet_repostory_1.getAllTweetsRepo)();
        if (tweets) {
...
const createTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const success = yield (0, tweet_repostory_1.createTweetRepo)(tweet);
        if (success) {
            const userUpdateSuccess = yield (0, user_repostory_1.updateUserWithTweetIDRepo)(tweet.adminId, tweet.tweetId);
...
const updateTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const success = yield (0, tweet_repostory_1.updateTweetRepo)(updatedTweet.tweetId, updatedTweet);
        if (success) {
...
const deleteTweetController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const tweetId = req.params.tweetId;
    try {
        const success = yield (0, tweet_repostory_1.deleteTweetRepo)(tweetId);
        if (success) {
